...
`,
      ...
      (t.Builder = function () {
              ...
              i[f] === void 0
                ...
                (k =
                  ...
                  (this._k1 *
                    (1 -
                      this._b +
                      this._b * (l / this.averageFieldLength[a])) +
                    m)),
                (k *= b),
                (k *= g),
            ...
            for (var o = 0; o < s.length; o++) {
              ...
              for (var u = 0; u < l.length; u++) {
                ...
                this.metadata[i][a][d] == null
                  ...
                  : (this.metadata[i][a][d] = this.metadata[i][a][
                      d
                    ].concat(e.metadata[i][a][d]));
              }
            }
          }
        }),
        ...
        (t.Query.prototype.isNegated = function () {
          for (var e = 0; e < this.clauses.length; e++)
            if (
              this.clauses[e].presence != t.Query.presence.PROHIBITED
            )
              return !1;
          return !0;
        }),
        ...
        (t.QueryLexer.lexText = function (e) {
          for (;;) {
            ...
            if (
              ...
              return (
                e.emit(t.QueryLexer.PRESENCE), t.QueryLexer.lexText
              );
        ...
        (t.QueryParser.parsePresence = function (e) {
          ...
          if (n != null) {
            switch (n.str) {
              ...
              default:
                var r =
                  "unrecognised presence operator'" + n.str + "'";
            ...
            switch (i.type) {
              ...
              default:
                var r =
                  "expecting term or field, found '" + i.type + "'";
  ...
  var U = class {
    ...
    updateIndexVisibility() {
      ...
      e && (e.open = !0),
        document
          .querySelectorAll('.tsd-index-section')
          .forEach((r) => {
  ...
  function ue(t, e) {
    ...
    if (!n)
      (n = t.querySelector(
        e == 1 ? 'li:first-child' : 'li:last-child',
      )),
      ...
      if (e === 1)
        ...
        while (r instanceof HTMLElement && r.offsetParent == null);
      r &&
        (n.classList.remove('current'), r.classList.add('current'));
    }
  }
  function Ne(t, e) {
    let n = t.querySelector('.current');
  ...
  document.addEventListener('click', (t) => {
    pe &&
      (t.preventDefault(), t.stopImmediatePropagation(), (pe = !1));
  });
...
`),
  ...
  function Ee(t, e, n) {
    if (t.path) {
      ...
      e.appendChild(document.createElement('span')).textContent =
        t.text;
  }
  G(X, 'a[data-toggle]');
